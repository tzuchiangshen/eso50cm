...
#ifndef ___home_tcsmgr_CURRENTLY_MOD_eso50cm_ESO50CM_Logger_src_LogPublisher_h__
#define ___home_tcsmgr_CURRENTLY_MOD_eso50cm_ESO50CM_Logger_src_LogPublisher_h__
...
class Callback_LogPublisher_logEvent_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_LogPublisher_logEvent_Base> Callback_LogPublisher_logEventPtr;
...
public:
    ...
    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData& log)
    {
        return begin_logEvent(log, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData& log, const ::Ice::Context& __ctx)
    {
        return begin_logEvent(log, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData& log, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_logEvent(log, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData& log, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_logEvent(log, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData& log, const ::Log::Callback_LogPublisher_logEventPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_logEvent(log, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData& log, const ::Ice::Context& __ctx, const ::Log::Callback_LogPublisher_logEventPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_logEvent(log, &__ctx, __del, __cookie);
    }

    void end_logEvent(const ::Ice::AsyncResultPtr&);
    
private:

    void logEvent(const ::Log::LogMessageData&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_logEvent(const ::Log::LogMessageData&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
inline bool operator==(const LogPublisher& l, const LogPublisher& r)
{
...
template<class T>
class CallbackNC_LogPublisher_logEvent : public Callback_LogPublisher_logEvent_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_LogPublisher_logEvent(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};

template<class T> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LogPublisher_logEvent<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LogPublisher_logEvent<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LogPublisher_logEvent<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LogPublisher_logEvent<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_LogPublisher_logEvent : public Callback_LogPublisher_logEvent_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_LogPublisher_logEvent(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};

template<class T, typename CT> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LogPublisher_logEvent<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LogPublisher_logEvent<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LogPublisher_logEvent<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_LogPublisher_logEventPtr
newCallback_LogPublisher_logEvent(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LogPublisher_logEvent<T, CT>(instance, 0, excb, sentcb);
}
