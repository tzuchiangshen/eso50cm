            ...
            if( goto_flag == 1 ) {
                ...
                if( diffPos < 30720 ) {                 // < 8[arcmin]
                    ...
                    if( diffPos < 16 )  {
                        ...
                        printf( ":end goto#" );
                        #endif
                	} else if( diffPos < 1920 ) {
                    	trgEncVelRef = 480;
                    	goto_flag = 2;
                  	} else if( diffPos < 30720 ) {
                    ...
                    sec = p_tmr0rv;
              	    ...
              	    if( diffPos < 61480 ) {             // < 16[arcmin]
              	        trgEncVelRef = 15360;           // 4[arcmin/s]
              	        trgThreshold = 15360;
              	    } else if( diffPos < 122800 ) {     // < 32[arcmin]
              	        trgEncVelRef = 30720;           // 8[arcmin/s]
              	        trgThreshold = 30720;
              	    } else if( diffPos < 245600 ) {     // < 64[arcmin]
              	        trgEncVelRef = 61400;           //16[arcmin/s]
              	        trgThreshold = 61400;
              	    } else if( diffPos < 491200 ) {     // < 128[arcmin]
              	        trgEncVelRef = 122880;          //32[arcmin/s]
              	        trgThreshold = 122880;
              	    } else {                            
              	        trgEncVelRef = 122880;          //32[arcmin/s]
              	        trgThreshold = 122880;
            ...
            switch( m_MtrCtrl ) {
                ...
                case NEWPID:
                    ...
                    if( tmp_float == 0 ){
                        ...
                        if( -16320 <  encVelRef && encVelRef < 16320 ) {
                            h_pid_flag = false;
                        } else {
                            h_pid_flag = true;
                        }
                        if( encVel != 0 ) {
                            if( encVelRef > encVelRef_old ) {
                                if( encVelRef - encVelRef_old > 7680 ) {
                                    if( h_pid_flag ) {
                                        m_MtrCtrl = STOPSLOWLY; 
                                    } else {
                                        m_MtrCtrl = STOP;
                                ...
                                if( encVelRef_old - encVelRef > 7680 ) {
                                    if( h_pid_flag ) {
                                        m_MtrCtrl = STOPSLOWLY; 
                                    } else {
                                        m_MtrCtrl = STOP;
