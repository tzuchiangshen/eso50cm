...
myLCU::myLCU( void )
{
    ...
    if( (int) m_shared_memory < 0) {
        ...
        if( verbose ) printf( "[myLCU::myLCU] Can't attach User Shared Memory!\n" );
...
void myLCU::readConfigurationFile( void )
{
    string line;
    ...
    if( config_file.is_open() ) {
        ...
        if( verbose ) printf( "[myLCU::readConfigurationFile] Unable to open Configuration File!\n" );
    }
}
*/
